...
import { VerifyEmailModal } from "./Modal-Verify-Account";
...
export function SignUpModal() {
  ...
  const [showVerifyModal, setShowVerifyModal] = useState(false); // Novo estado
  ...
  const handleVerification = async (code: string) => {
    try {
      await verifyCode({ email: formData.email, code });
