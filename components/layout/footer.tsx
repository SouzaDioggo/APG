      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm font-light leading-relaxed">
              Consultoria estratégica focada em transformação organizacional e
              crescimento sustentável. Combinamos expertise técnica com visão
              estratégica para entregar resultados mensuráveis em gestão de
              contratos, compliance e estruturação empresarial.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-500 text-xs font-light mb-4 md:mb-0">
            © 2026 APG - Educação Empresarial & Treinamento. Todos os direitos
            reservados.
          </p>
