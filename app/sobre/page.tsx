      ...
      <section className="relative py-20 bg-linear-to-br from-[#1a4d7a] to-[#0d2d4a]">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6 font-serif">
            Sobre a{" "}
            <span className="bg-linear-to-r from-[#c9a961] to-[#d4b876] bg-clip-text text-transparent">
              APG
            </span>
          </h1>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Conheça nossa história, missão e os serviços que transformam
            organizações em empresas de excelência.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-linear-to-br from-slate-50 to-slate-100 p-8 rounded-lg border border-slate-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Buscamos constantemente novas metodologias e tecnologias para
            ...
            <div className="bg-linear-to-br from-slate-50 to-slate-100 p-8 rounded-lg border border-slate-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Não aceitamos mediocridade. Cada projeto é executado com
            ...
            <div className="bg-linear-to-br from-slate-50 to-slate-100 p-8 rounded-lg border border-slate-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Comunicação clara e honesta em todos os processos. Você sempre
                sabe o que esperar de nós.
              </p>
            </div>
          </div>
        </div>
